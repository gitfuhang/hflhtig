		 ...
		 <div class="modal-dialog">
			  <div class="modal-content">
				...
				<div class="modal-footer">
						<div class="col-sm-6 col-md-11" style="margin-top:4%;margin-bottom:2%">				
							<div class="col-sm-6 col-md-4">		
									<img id="QQLogin" class="imgA"  src="../images/QQ1.png" alt="QQ登录">
									<span  class="thirdloginspan" >QQ登录</span>				
							</div>
							<div class="col-sm-6 col-md-4">
									<img id="WXLogin" class="imgA"  src="../images/WX1.png" alt="微信登录">
									<span  class="thirdloginspan" >微信登录</span>
							</div>
							<div class="col-sm-6 col-md-4">
									<img id="WBLogin" class="imgA" src="../images/WB4.png" alt="微博登录">
									<span  class="thirdloginspan" >微博登录</span>
							</div>
						</div>		
				</div>
			 </div>
